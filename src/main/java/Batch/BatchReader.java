 ...
 * @author Sander
 */
@WebServlet(name = "BatchReader", urlPatterns = {"/BatchReader"})
public class BatchReader extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BatchReader</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BatchReader at " + request.getContextPath() + "</h1>");
            ...
            out.println("Kweets run test number: " + jid + "<br>");
            out.println("</body>");
            out.println("</html>");
